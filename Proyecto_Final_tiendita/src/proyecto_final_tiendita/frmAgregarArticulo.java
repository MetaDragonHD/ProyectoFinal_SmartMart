...
public class frmAgregarArticulo extends javax.swing.JFrame {
    ...
    private void btnAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarMouseClicked
        ...
        if (("".equals(txtArticulo.getText())) || ("".equals(txtCantidadActual.getText())) || ("".equals(txtCodigo.getText())) || ("".equals(txtPrecioCompra.getText())) || ("".equals(txtPrecioVenta.getText()))){
            JOptionPane.showMessageDialog(null, "Hay un campo vacio, verificar por favor");
        }
        else{
            try{
                ...
                String sql = "INSERT INTO inventario_smartmart (codigo, descripcion, prc_costo, prc_venta, prc_mayoreo, inv_minimo, inventario, departamento) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
                try {
                    pr = BD.conectar.prepareStatement(sql);
                    pr.setInt(1, codigo);
                    ...
                    if (filasInsertadas > 0) {
                        System.out.println("Nueva entrada agregada correctamente a la tabla");
                    } else {
                        System.out.println("Error al agregar la nueva entrada a la tabla");
                    }
                } catch (Exception e) {
                    System.out.println("Error al ejecutar la inserción: " + e.getMessage());
                }
            }catch (NumberFormatException nfe) {
                JOptionPane.showMessageDialog(null, "Verificar que la cantidad, el codigo o los precios sean numericos");
            }
        }
